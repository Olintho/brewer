package br.com.orei.brewer.session;
...
import br.com.orei.brewer.session.TabelaItensVenda;
...
public class TabelaItensVendaTest {
	...
	@Test
	public void deveCalcularValorTotalComItem() {
	...
	public void deveManterTamanhoDaListaParaMesmasCervejas() throws Exception {
		...
		assertEquals(new BigDecimal("9.0"), tabelaItensVenda.getValorTotal());
	}
